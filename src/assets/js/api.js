...
len = doms.length;
  ...
  u.addCls = function (el, cls) {
    ...
    if ('classList' in el) {
      ...
      let preCls = el.className;
      let newCls = `${preCls  } ${  cls}`;
      el.className = newCls;
    }
    return el;
  };
  ...
  u.post = function (/* url,data,fnSuc,dataType*/) {
    let argsToJson = parseArguments(...arguments);
    let json = {};
    let fnSuc = argsToJson.fnSuc;
    argsToJson.url && (json.url = argsToJson.url);
    argsToJson.data && (json.data = argsToJson.data);
    if (argsToJson.dataType) {
      let type = argsToJson.dataType.toLowerCase();
